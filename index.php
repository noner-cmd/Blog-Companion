    ...
    <?php if ($showContent): ?>
        ...
        <div class="content">
            ...
            <div class="button-group">
                <a href="/add.php" class="btn">添加友链</a>
                <a href="/essay.php" class="btn">撰写即刻</a>
                <a href="/todo.php" class="btn">编辑Todo</a>
                <a href="/project.php" class="btn">编辑“项目”</a>
                <a href="/scj.php" class="btn">编辑“收藏”</a>
                <a href="/music.php" class="btn">刷新音乐</a>
            </div>
